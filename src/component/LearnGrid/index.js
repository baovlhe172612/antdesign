...
function LearnGrid() {
    return (
        ...
        //             </div>
        //         </Col>
        //         <Col xxl={4} l={4} lg={3} md={6} sm={12} xs={24}>
        //             <div className="box">
        //                 Cột 2
        //             </div>
        //         </Col>
        //         <Col xxl={8} l={8} lg={9} md={6} sm={12} xs={24}>
        //             <div className="box">
        //                 Cột 3
        //             </div>
        //         </Col>
        ...
        <>
            <Row gutter={[20, 20]}>
                <Col xxl={6} xl={6} lg={6} md={12} sm={24}>
            ...
            <Row gutter={[20, 20]} className="mt-20">
                <Col xxl={16} xl={16} lg={12} md={24} sm={24}>
            ...
            <Row gutter={[20, 20]} className="mt-20">
                <Col xxl={8} xl={16} lg={12} md={24} sm={24}>
                    <CartItem title="Box 7" style={{height: "400px"}}/>
                </Col>
                <Col xxl={16} xl={8} lg={12} md={24} sm={24}>
